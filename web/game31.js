...
Promise.all([
 ...
 fetch(v('runtime31_manifest.json')).then(r=>{if(!r.ok)throw new Error(`Unable to load Build 31A.6 manifest (${r.status})`);return r.json();})

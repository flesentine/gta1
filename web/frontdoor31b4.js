(() => {
'use strict';
if (window.__gtaFrontDoor31B4) return;
window.__gtaFrontDoor31B4 = true;
...
function removeFrontDoor() {
  ...
  if (d && !d.textContent.includes('BITMAP-CROWD')) d.textContent = '31B.4 · BITMAP-CROWD TEST · F1 VECTOR / F2 BITMAP';
  return true;
}
...
const observer = new MutationObserver(() => {
  ...
  while ((node = walker.nextNode())) {
    ...
    node.nodeValue = node.nodeValue
      .replace(/BUILD 28/g, 'BUILD 31B.4')
      .replace(/BUILD 29/g, 'BUILD 31B.4')
      .replace(/BUILD 31A\.1/g, 'BUILD 31B.4')
      .replace(/BUILD 31A\.3/g, 'BUILD 31B.4')
      .replace(/BUILD 31A\.4/g, 'BUILD 31B.4')
      .replace(/BUILD 31A\.5/g, 'BUILD 31B.4')
      .replace(/BUILD 31A\.6/g, 'BUILD 31B.4')
      .replace(/BUILD 31A\.7/g, 'BUILD 31B.4')

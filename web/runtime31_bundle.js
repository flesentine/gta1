...
if(!manifest||!Array.isArray(manifest.modules))throw new Error('Build 31A.6 runtime manifest unavailable');
...
Promise.all(manifest.modules.map(name=>fetch(`${name}?v=31a6`).then(r=>{
